...
/**
 * Upgrades to version 53.
 */
final class UpgraderToVersion53 implements SingleStepSchemaUpgrader {

  private static final Log log = LogFactory.getLog(UpgraderToVersion53.class);
  ...
  public void upgrade(final Connection conn, final int upgradeToVersion) throws SQLException {
    ...
    try {
      ...
      PersistanceUtils.executeDDLs(st, new String[]{
        //
        "alter table BUILD_WATCHER drop constraint BUILD_WATCHER_UC2 ",
      });
