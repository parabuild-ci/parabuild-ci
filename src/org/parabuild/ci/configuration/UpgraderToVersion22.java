 ...
 */
final class UpgraderToVersion22 implements SingleStepSchemaUpgrader {

  private static final Log log = LogFactory.getLog(UpgraderToVersion22.class);
  ...
  public void upgrade(final Connection conn, final int upgradeToVersion) throws SQLException {
    ...
    try {
      ...
      final String [] update = {" drop index BUILD_RUN_IX2 ",
        " alter table BUILD_RUN add column RERUN char(1)  default 'N' not null ",
        " update BUILD_RUN set RERUN='N' ",
        " alter table BUILD_RUN alter column RERUN drop default ",
