...
/**
 * Upgrades to version 36. Alters source control properties to
 * hold 4 kilobytes property values.
 */
final class UpgraderToVersion36 implements SingleStepSchemaUpgrader {

  private static final Log log = LogFactory.getLog(UpgraderToVersion36.class);
