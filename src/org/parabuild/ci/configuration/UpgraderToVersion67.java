...
/**
 * Upgrades to version 67.
 */
final class UpgraderToVersion67 implements SingleStepSchemaUpgrader {

  private static final Log LOG = LogFactory.getLog(UpgraderToVersion67.class); // NOPMD
