 ...
 */
final class UpgraderToVersion80 implements SingleStepSchemaUpgrader {

  private static final Log LOG = LogFactory.getLog(UpgraderToVersion80.class); // NOPMD
  ...
  public void upgrade(final Connection connection, final int upgradeToVersion) throws SQLException {
    ...
    try {
      ...
      PersistanceUtils.executeDDLs(st, new String[]{
              ...
              " alter table AGENT add column MAX_CONCURRENT_BUILDS int default 1 not null ",
              " update AGENT set MAX_CONCURRENT_BUILDS=0",
              " alter table AGENT alter column MAX_CONCURRENT_BUILDS drop default ",
      });
