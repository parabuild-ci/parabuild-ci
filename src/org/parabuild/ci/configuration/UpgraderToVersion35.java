...
/**
 * Upgrades to version 35. Alters source control properties to
 * hold 4 kilobytes property values.
 */
final class UpgraderToVersion35 implements SingleStepSchemaUpgrader {

  private static final Log log = LogFactory.getLog(UpgraderToVersion35.class);
  ...
  public void upgrade(final Connection conn, final int upgradeToVersion) throws SQLException {
    ...
    try {
      ...
      final String [] update = {
        "alter table BUILD_CONFIG drop column RUNNER",
      };
