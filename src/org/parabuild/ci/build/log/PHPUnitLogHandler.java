...
/**
 * Handles directory with PHPUnit logs
 */
public final class PHPUnitLogHandler extends AbstractLogHandler {
   ...
   * Constructor
   */
  public PHPUnitLogHandler(final Agent agent, final BuildRunConfig buildRunConfig,
  ...
  protected void processLog() throws IOException {
    ...
    try {
      ...
      for (final Iterator i = tempFiles.iterator(); i.hasNext();) {
        ...
        // validate it is PHPUnit - should have testsuites as root
      ...
      cm.addStepStatistics(super.stepRunID, StepRunAttribute.ATTR_PHPUNIT_ERRORS, errors);
      cm.addStepStatistics(super.stepRunID, StepRunAttribute.ATTR_PHPUNIT_FAILURES, failures);
      cm.addStepStatistics(super.stepRunID, StepRunAttribute.ATTR_PHPUNIT_SUCCESSES, successes);
      cm.addStepStatistics(super.stepRunID, StepRunAttribute.ATTR_PHPUNIT_TESTS, tests);
      ...
      stepLog.setPathType(StepLog.PATH_TYPE_PHPUNIT_XML);
