...
public interface BuildScriptGenerator {
  ...
  public static final String VAR_PARABUILD_GIT_BRANCH = "PARABUILD_GIT_BRANCH";
  public static final String VAR_PARABUILD_BUILD_DATE = "PARABUILD_BUILD_DATE";
  public static final String VAR_PARABUILD_BUILD_DIR = "PARABUILD_BUILD_DIR";
  public static final String VAR_PARABUILD_BUILD_NAME = "PARABUILD_BUILD_NAME";
  public static final String VAR_PARABUILD_BUILD_NUMBER = "PARABUILD_BUILD_NUMBER";
  public static final String VAR_PARABUILD_BUILD_RUN_ID = "PARABUILD_BUILD_RUN_ID";
  public static final String VAR_PARABUILD_BUILD_ID = "PARABUILD_BUILD_ID";
  public static final String VAR_PARABUILD_BUILD_STARTED_BY_USER = "PARABUILD_BUILD_STARTED_BY_USER";
  public static final String VAR_PARABUILD_BUILD_TIMESTAMP = "PARABUILD_BUILD_TIMESTAMP";
  public static final String VAR_PARABUILD_BUILD_TIMESTAMP_UTC = "PARABUILD_BUILD_TIMESTAMP_UTC";
  public static final String VAR_PARABUILD_CLEAN_CHECKOUT = "PARABUILD_CLEAN_CHECKOUT";
  public static final String VAR_PARABUILD_CHANGE_LIST_DATETIME = "PARABUILD_CHANGE_LIST_DATETIME";
  public static final String VAR_PARABUILD_CHANGE_LIST_NUMBER = "PARABUILD_CHANGE_LIST_NUMBER";
  public static final String VAR_PARABUILD_CHECKOUT_DIR = "PARABUILD_CHECKOUT_DIR";
  public static final String VAR_PARABUILD_CONFIGURATION_ID = "PARABUILD_CONFIGURATION_ID";
  public static final String VAR_PARABUILD_PROJECT_ID = "PARABUILD_PROJECT_ID";
  public static final String VAR_PARABUILD_PROJECT_NAME = "PARABUILD_PROJECT_NAME";
  public static final String VAR_PARABUILD_STEP_NAME = "PARABUILD_STEP_NAME";
  public static final String VAR_PARABUILD_VERSION_COUNTER = "PARABUILD_VERSION_COUNTER";
  public static final String VAR_PARABUILD_VERSION = "PARABUILD_VERSION";
  public static final String VAR_PARABUILD_LEADING_BUILD_ID = "PARABUILD_LEADING_BUILD_ID";
  public static final String VAR_PARABUILD_LEADING_BUILD_NAME = "PARABUILD_LEADING_BUILD_NAME";
  public static final String VAR_PARABUILD_LEADING_BUILD_RUN_ID = "PARABUILD_LEADING_BUILD_RUN_ID";
  public static final String VAR_PARABUILD_SEQUENCE_NUMBER = "PARABUILD_SEQUENCE_NUMBER";
  public static final String VAR_PARABUILD_PREVIOUS_CHANGE_LIST_DATETIME = "PARABUILD_PREVIOUS_CHANGE_LIST_DATETIME";
  public static final String VAR_PARABUILD_PREVIOUS_CHANGE_LIST_NUMBER = "PARABUILD_PREVIOUS_CHANGE_LIST_NUMBER";
  public static final String VAR_PARABUILD_LAST_GOOD_BUILD_NUMBER = "PARABUILD_LAST_GOOD_BUILD_NUMBER";
  public static final String VAR_PARABUILD_LAST_GOOD_BUILD_DATETIME = "PARABUILD_LAST_GOOD_BUILD_DATETIME";
  public static final String VAR_PARABUILD_LAST_GOOD_CHANGE_LIST_DATETIME = "PARABUILD_LAST_GOOD_CHANGE_LIST_DATETIME";
  public static final String VAR_PARABUILD_LAST_GOOD_CHANGE_LIST_NUMBER = "PARABUILD_LAST_GOOD_CHANGE_LIST_NUMBER";
  public static final String VAR_PARABUILD_UPSTREAM_BUILD_RUN_ID = "PARABUILD_UPSTREAM_BUILD_RUN_ID";
  public static final String VAR_PARABUILD_UPSTREAM_BUILD_ID = "PARABUILD_UPSTREAM_BUILD_ID";
  public static final String VAR_PARABUILD_UPSTREAM_BUILD_NAME = "PARABUILD_UPSTREAM_BUILD_NAME";
  public static final String VAR_PARABUILD_PREVIOUS_STEPS = "PARABUILD_PREVIOUS_STEPS";
  public static final String BUILD_DATE_FORMAT = "yyyyMMdd";
  public static final String BUILD_TIMESTAMP_FORMAT = "yyyyMMddHHmmss";
