...
/**
 * Default implementation of the {@link BuildRunnerVersionControlFactory}.
 *
 * Just delegates VCS creation to {@link VersionControlFactory}.
 */
final class DefaultBuildRunnerVersionControlFactory implements BuildRunnerVersionControlFactory {
  ...
  public SourceControl getVersionControl(final BuildConfig buildConfig) {
    return VersionControlFactory.makeVersionControl(buildConfig);
  }
}
