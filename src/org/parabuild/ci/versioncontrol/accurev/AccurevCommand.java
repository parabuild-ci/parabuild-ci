...
abstract class AccurevCommand extends VersionControlRemoteCommand {
  ...
  protected static String toStringEolType(final byte eolType) {
    switch (eolType) {
      case SourceControlSetting.ACCUREV_EOL_PLATFORM:
        return "";
      case SourceControlSetting.ACCUREV_EOL_UNIX:
        return "-eu";
      case SourceControlSetting.ACCUREV_EOL_WINDOWS:
        return "-ew";
      default:
  ...
  protected static String toStringKind(final byte kind) {
    switch (kind) {
      case SourceControlSetting.ACCUREV_WORKSPACE_LOKING_NONE:
        return "";
      case SourceControlSetting.ACCUREV_WORKSPACE_LOKING_EXCLUSIVE:
        return "-ke";
      case SourceControlSetting.ACCUREV_WORKSPACE_LOKING_ANCHOR:
        return "-ka";
      default:
