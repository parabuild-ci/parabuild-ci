 ...
 */
public final class PMDLogComponent extends AbstractXSLRendererComponent {
  ...
  public PMDLogComponent(final ArchiveManager archiveManager, final StepLog stepLog) {
  ...
  protected StreamSource xslSource() throws IOException {
    return new StreamSource(new StringReader(IoUtils.getResourceAsString("pmd-report.xsl")));
  }
}
