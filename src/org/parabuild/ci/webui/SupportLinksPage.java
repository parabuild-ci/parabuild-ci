...
/**
 * This class is a admin support repsources
 */
public final class SupportLinksPage extends BasePage implements StatelessTierlet {

  static final long serialVersionUID = 644441224120456213L; // NOPMD

  public static final String VIEWTIER_SUPPORT_HOME_URL = "http://www.parabuildci.org/support.htm";
  public static final String VIEWTIER_SUPPORT_HOME_CAPTION = "Parabuild CI technical support home";
