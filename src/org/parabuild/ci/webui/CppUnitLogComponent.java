...
/**
 * CppUnitLogComponent is a custom leaf component responsible for
 * displaying build logs presented as unaltered readers.
 */
public final class CppUnitLogComponent extends AbstractXSLRendererComponent {
   ...
   * Constructor
   */
  public CppUnitLogComponent(final ArchiveManager archiveManager, final StepLog stepLog) {
  ...
  protected StreamSource xslSource() throws IOException {
    return new StreamSource(new StringReader(IoUtils.getResourceAsString("cppunit-log-report.xsl")));
  }
}
