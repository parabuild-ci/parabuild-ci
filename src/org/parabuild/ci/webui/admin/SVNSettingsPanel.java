...
public final class SVNSettingsPanel extends AbstractSourceControlPanel {
  ...
  public SVNSettingsPanel() {
    ...
    propertyToInputMap.bindPropertyNameToInput(SourceControlSetting.SVN_PASSWORD, flPassword);
    propertyToInputMap.bindPropertyNameToInput(SourceControlSetting.SVN_USER, flUser);
    propertyToInputMap.bindPropertyNameToInput(SourceControlSetting.SVN_DEPOT_PATH, flDepotPath);
    propertyToInputMap.bindPropertyNameToInput(SourceControlSetting.SVN_PATH_TO_EXE, flPathToExe);
    propertyToInputMap.bindPropertyNameToInput(SourceControlSetting.SVN_URL, flURL);
    propertyToInputMap.bindPropertyNameToInput(SourceControlSetting.SVN_WATCH_NON_RECURSIVE_PATHS, flWatchNonRecursivePaths);
    propertyToInputMap.bindPropertyNameToInput(SourceControlSetting.SVN_ADD_OPTION_TRUST_SERVER_CERT, flAddTrustServerCert);
    propertyToInputMap.bindPropertyNameToInput(SourceControlSetting.SVN_IGNORE_EXTERNALS, flIgnoreExternals);
