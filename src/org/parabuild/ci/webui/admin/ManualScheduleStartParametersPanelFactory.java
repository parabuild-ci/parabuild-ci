...
final class ManualScheduleStartParametersPanelFactory {
  ...
  private static final String P4_CLIENT_VIEW_SOURCE = VersionControlSystem.P4_CLIENT_VIEW_SOURCE;
  private static final byte P4_CLIENT_VIEW_SOURCE_VALUE_CLIENT_NAME = VersionControlSystem.P4_CLIENT_VIEW_SOURCE_VALUE_CLIENT_NAME;
  private static final byte P4_CLIENT_VIEW_SOURCE_VALUE_DEPOT_PATH = VersionControlSystem.P4_CLIENT_VIEW_SOURCE_VALUE_DEPOT_PATH;
