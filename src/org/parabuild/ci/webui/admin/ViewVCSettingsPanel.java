...
public final class ViewVCSettingsPanel extends AbstractSourceControlPanel {
  ...
  public ViewVCSettingsPanel(final boolean showViewVCRoot) {
    ...
    propertyToInputMap.bindPropertyNameToInput(VersionControlSystem.VIEWCVS_URL, flViewVCURL);
    propertyToInputMap.bindPropertyNameToInput(VersionControlSystem.VIEWCVS_ROOT, flViewVCRoot);
  }
