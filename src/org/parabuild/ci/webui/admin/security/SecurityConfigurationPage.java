 ...
 * properties.
 */
public final class SecurityConfigurationPage extends AbstractSystemConfigurationPage implements ConversationalTierlet {
   ...
   * Constructor
   */
  public SecurityConfigurationPage() {
    super(Pages.ADMIN_SECURITY_CONFIGURATION, new SecurityConfigPanel());
    setTitle(makeTitle(GENERAL_SETTINGS));
  }
}
