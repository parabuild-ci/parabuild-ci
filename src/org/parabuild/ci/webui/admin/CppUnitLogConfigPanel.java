...
/**
 * Panel to configure a CppUnit XML log.
 *
 * This panel does not present any additional controls because all we
 * need for CppUnit is path to a directory with CppUnit XML logs.
 *
 * @see AbstractLogConfigPanel
 */
public final class CppUnitLogConfigPanel extends AbstractLogConfigPanel {
