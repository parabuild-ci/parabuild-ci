 ...
 *
 */
public final class WebSVNSettingsPanel extends AbstractSourceControlPanel implements Validatable, Saveable {
  ...
  public WebSVNSettingsPanel(final boolean showViewVCRoot) {
    ...
    propertyToInputMap.bindPropertyNameToInput(SourceControlSetting.WEB_SVN_URL, flBaseUrl);
    propertyToInputMap.bindPropertyNameToInput(SourceControlSetting.WEB_SVN_REPNAME, flRepname);
