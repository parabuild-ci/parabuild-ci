...
/**
 * Panel to configure a Checkstyle XML log.
 *
 * This panel does not present any additional controls because all we
 * need for Checkstyle is path to a Checkstyle XML file log.
 *
 * @see AbstractLogConfigPanel
 */
public final class CheckstyleLogConfigPanel extends AbstractLogConfigPanel {
