...
public final class BuildConfigTabs extends Tabs implements Saveable, Validatable {
  ...
  private static final String CAPTION_DISPALY_GROUPS = "Display Groups";
...
//  private SecuritySettingsPanel pnlSecurity = null;
  ...
  public BuildConfigTabs(final BuildConfig buildConfig) {
    ...
    if (scheduleType == BuildConfig.SCHEDULE_TYPE_RECURRENT || sourceControl == BuildConfig.SCM_PERFORCE) {
    ...
    tblIssueTrackers.setWidth(Pages.PAGE_WIDTH);
    tabIndexDisplayGroups = addConfigTab(CAPTION_DISPALY_GROUPS, tblDisplayGroups);
