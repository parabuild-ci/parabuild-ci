 ...
 */
public abstract class AbstractScheduleSettingsPanel extends ScheduleSettingsPanel { // NOPMD - "This abstract class does not have any abstract methods"
   ...
   */
  public AbstractScheduleSettingsPanel(final String title) {
    super(title);
  ...
  public void load(final BuildConfig buildConfig) {
    ...
    if (buildConfig.getSourceControl() == VCSAttribute.SCM_ACCUREV) {
  ...
  public String toString() {
    return "AbstractScheduleSettingsPanel{" +
            "buildID=" + buildID +
