...
final class ConnectionSecurityLevelDropDown extends CodeNameDropDown {
  ...
  public ConnectionSecurityLevelDropDown() {
    ...
    addCodeNamePair(ConfigurationConstants.LDAP_CONNECTION_SECURITY_LEVEL_SIMPLE, ConfigurationConstants.LDAP_CONNECTION_SECURITY_LEVEL_SIMPLE_VALUE);
    addCodeNamePair(ConfigurationConstants.LDAP_CONNECTION_SECURITY_LEVEL_STRONG, ConfigurationConstants.LDAP_CONNECTION_SECURITY_LEVEL_STRONG_VALUE);
    setCode(ConfigurationConstants.LDAP_CONNECTION_SECURITY_LEVEL_SIMPLE);
  }
}
