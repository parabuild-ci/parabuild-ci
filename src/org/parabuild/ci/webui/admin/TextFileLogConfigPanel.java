...
/**
 * Panel to configure single file customer build log
 *
 * @see AbstractLogConfigPanel
 */
public final class TextFileLogConfigPanel extends AbstractLogConfigPanel {
   ...
   */
  public TextFileLogConfigPanel() {
    super(false); // no conent border
    setLogType(LogConfig.LOG_TYPE_TEXT_FILE);
  }
