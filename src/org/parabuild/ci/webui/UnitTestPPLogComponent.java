...
public final class UnitTestPPLogComponent extends AbstractXSLRendererComponent {
   ...
   * Constructor
   */
  public UnitTestPPLogComponent(final ArchiveManager archiveManager, final StepLog stepLog) {
  ...
  protected StreamSource xslSource() throws IOException {
    return new StreamSource(new StringReader(IoUtils.getResourceAsString("unittestpp-log-report.xsl")));
  }
}