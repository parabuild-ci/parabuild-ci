...
/**
 */
public final class SelectProjectPanel extends MessagePanel {
   ...
   */
  public SelectProjectPanel(final String gotoPageWhenProjectSelected, final String gotoPageWhenSelectionCanceled) {
    super(true);
    setWidth("100%");
    ...
    btnContinue.addListener(new ButtonPressedListener() {
      ...
      public Tierlet.Result buttonPressed(final ButtonPressedEvent buttonPressedEvent) {
        ...
        if (projectDropDown.getCode() == ProjectDropDown.NOT_SELECTED_ID) {
          ...
          showErrorMessage(SelectProjectPanel.MESSAGE_PLEASE_SELECT_PROJECT);
        ...
        return Tierlet.Result.Done(gotoPageWhenProjectSelected, parameters);
      }
    });
