...
public final class GoogleTestLogComponent extends AbstractXSLRendererComponent {
  ...
  /**
   * Creates GoogleTestLogComponent.
   */
  public GoogleTestLogComponent(final ArchiveManager archiveManager, final StepLog stepLog) {
  ...
  protected StreamSource xslSource() throws IOException {
    ...
    // NOTE: simeshev@parabuilci.org - 2009-10-10 - GoogleTests's file
    // format is the same as merged JUnit's test
    return new StreamSource(new StringReader(IoUtils.getResourceAsString("junit-log-report.xsl")));
  }
}