...
/**
 * Panel to display recent PMD violations.
 */
public final class RecentPMDStatisticsPanel extends MessagePanel {
   ...
   * Constructor.
   */
  public RecentPMDStatisticsPanel(final ActiveBuildConfig bc) {
    setTitle("Recent PMD Violations for " + bc.getBuildName());
    setStyle(PAGE_SECTION);
    getUserPanel().add(new Image(WebuiUtils.makeStatisticsChartURL(bc.getBuildID(),
      StatisticsImageServlet.STATISTICS_PMD_IMAGE_RECENT_BUILDS),
      "Recent PMD Violations",
