...
/**
 * Reusable text box field that supports {@link HasInputValue}.
 */
public class ParabuildTextBox extends TextBox implements HasInputValue {

  /**
   * Creates an empty text box of data size <code>maxLength</code> characters and visible length of
   * <code>visibleLength</code> characters.
   */
