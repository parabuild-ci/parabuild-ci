 ...
 * Daily distribution.
 *
 * @hibernate.class table="WEEKDAY_DISTRIBUTION"
 * dynamic-update="true"
 * @hibernate.cache usage="read-write"
 */
public final class WeekDayDistribution implements Serializable, ObjectConstants, PersistentDistribution, Lifecycle {
  ...
  private void validateDayOfWeek() throws CallbackException {
    if (target > 24 || target < 1) throw new CallbackException("Invalid hour: " + 24);
  }
}
