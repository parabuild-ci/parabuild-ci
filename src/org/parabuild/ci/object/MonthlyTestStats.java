 ...
 * Daily statistics.
 *
 * @hibernate.class table="MONTHLY_TEST_STATS" dynamic-update="true"
 * @hibernate.cache usage="read-write"
 */
public final class MonthlyTestStats implements Serializable, ObjectConstants, PersistentTestStats {
