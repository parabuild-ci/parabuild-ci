 ...
 *
 * @hibernate.class table="MERGE_TARGET_BUILD_RUN"
 * dynamic-update="true"
 * @hibernate.cache usage="read-write"
 */
public class MergeTargetBuildRun implements Serializable, ObjectConstants {

  private static final long serialVersionUID = 7623173234163497836L;
  ...
  public MergeTargetBuildRun() {
  }


  public MergeTargetBuildRun(final int mergeID, final int buildRunID) {
