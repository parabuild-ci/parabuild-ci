 ...
 * Daily statistics.
 *
 * @hibernate.class table="DAILY_TEST_STATS" dynamic-update="true"
 * @hibernate.cache usage="read-write"
 */
public final class DailyTestStats implements Serializable, ObjectConstants, PersistentTestStats {
