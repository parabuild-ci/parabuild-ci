...
public class TestSuiteName implements Serializable {
  ...
  private static final TypeDesc typeDesc =
          new TypeDesc(TestSuiteName.class, true);


  static {
    typeDesc.setXmlType(new QName("http://org.parabuild.ci", "TestSuiteName"));
