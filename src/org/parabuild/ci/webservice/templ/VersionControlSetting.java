...
public class VersionControlSetting implements Serializable {

  private static final long serialVersionUID = 3855669746735671947L;
  private int buildID;
  ...
  private static final TypeDesc typeDesc =
          new TypeDesc(VersionControlSetting.class, true);


  static {
    typeDesc.setXmlType(new QName("http://org.parabuild.ci", "SourceControlSetting"));
