...
public class ResultConfigurationProperty implements Serializable {

  private static final long serialVersionUID = -9036456347619644163L;
  private int ID;
  private String name;
  ...
  private static final TypeDesc typeDesc =
          new TypeDesc(ResultConfigurationProperty.class, true);


  static {
    typeDesc.setXmlType(new QName("http://org.parabuild.ci", "ResultConfigProperty"));
    ...
    elemField.setXmlName(new QName("http://org.parabuild.ci", "resultConfigID"));
    elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "int"));
    elemField.setNillable(false);
    typeDesc.addFieldDesc(elemField);
    elemField = new ElementDesc();
