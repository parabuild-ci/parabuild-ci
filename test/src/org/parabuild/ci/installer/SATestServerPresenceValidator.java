...
public final class SATestServerPresenceValidator extends TestCase {
  ...
  public static TestSuite suite() {
    return new TestSuite(SATestServerPresenceValidator.class);
  }


  public SATestServerPresenceValidator(final String s) {
    super(s);
  }
}
