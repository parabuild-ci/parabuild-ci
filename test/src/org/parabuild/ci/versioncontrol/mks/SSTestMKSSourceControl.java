...
//    TestHelper.assertDirIsEmpty(TestHelper.JAVA_TEMP_DIR);
  ...
  public void test_checkOutLatestCantProcessUnexistingSourceLine() throws Exception {
    // alter
    TestHelper.setSourceControlProperty(mks.getBuildID(), VersionControlSystem.MKS_PROJECT, "/opt/mks/integrity_server2005/mksis/projects/never_existed_project.pj");
    mks.reloadConfiguration();
  ...
  public void test_checkOutLatestCantProcessInavalidUser() throws Exception {
    // alter
    TestHelper.setSourceControlProperty(mks.getBuildID(), VersionControlSystem.MKS_USER, NEVER_EXISTED_USER);
    mks.reloadConfiguration();
