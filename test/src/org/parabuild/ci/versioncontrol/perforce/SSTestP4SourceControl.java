...
public class SSTestP4SourceControl extends ServersideTestCase {
  ...
  public void test_createClientNoUNC() throws Exception {
    TestHelper.setSourceControlProperty(TEST_BUILD_ID, SourceControlSetting.P4_USE_UNC_PATHS, SourceControlSetting.OPTION_UNCHECKED);
  ...
  public void test_syncToChangeListWithClobber() throws Exception {
    TestHelper.setSourceControlProperty(TEST_BUILD_ID, SourceControlSetting.P4_CLOBBER_OPTION, Byte.toString(SourceControlSetting.P4_OPTION_VALUE_CLOBBER));
  ...
  public void test_syncToChangeListWithDepotSourcePath() throws Exception {
    ...
    TestHelper.setSourceControlProperty(TEST_BUILD_ID, SourceControlSetting.P4_CLIENT_VIEW_SOURCE, Byte.toString(SourceControlSetting.P4_CLIENT_VIEW_SOURCE_VALUE_DEPOT_PATH));
    TestHelper.setSourceControlProperty(TEST_BUILD_ID, SourceControlSetting.P4_CLIENT_VIEW_BY_DEPOT_PATH, DEPOT_PATH_SOURCE);
    perforce.reloadConfiguration();
    perforce.syncToChangeList(TEST_CHANGE_LIST_ID_10);
    TestHelper.assertCheckoutDirNotEmpty(agent);
  ...
  public void test_syncsToChangeListWithDepotSourcePathBug1375() throws Exception {
    TestHelper.emptyCheckoutDir(agent);
    TestHelper.setSourceControlProperty(TEST_BUILD_ID, SourceControlSetting.P4_CLIENT_VIEW_SOURCE, Byte.toString(SourceControlSetting.P4_CLIENT_VIEW_SOURCE_VALUE_DEPOT_PATH));
    TestHelper.setSourceControlProperty(TEST_BUILD_ID, SourceControlSetting.P4_CLIENT_VIEW_BY_DEPOT_PATH, DEPOT_PATH_SOURCE_3);
    TestHelper.setSourceControlProperty(TEST_BUILD_ID, SourceControlSetting.P4_ADVANCED_VIEW_MODE, SourceControlSetting.OPTION_CHECKED);
    TestHelper.setSourceControlProperty(TEST_BUILD_ID, SourceControlSetting.P4_RELATIVE_BUILD_DIR, "test");
    perforce.reloadConfiguration();
    perforce.syncToChangeList(TEST_CHANGE_LIST_ID_10);
  ...
  public void test_syncToChangeListWithDepotSourcePathDetectsChangesInDepotPath() throws Exception {
    ...
    if (log.isDebugEnabled())
      log.debug("==================================== step 2 ================================= ");
    // change
    TestHelper.setSourceControlProperty(TEST_BUILD_ID, SourceControlSetting.P4_CLIENT_VIEW_BY_DEPOT_PATH, DEPOT_PATH_SOURCE_2);
    perforce.reloadConfiguration();
    perforce.syncToChangeList(TEST_CHANGE_LIST_ID_10);
    TestHelper.assertCheckoutDirNotEmpty(agent);
    // both do not exist
  ...
  public void test_syncToChangeListWithDepotSourcePathFailsOnNonExistingPath() throws CommandStoppedException {
    try {
      TestHelper.emptyCheckoutDir(agent);
      TestHelper.setSourceControlProperty(TEST_BUILD_ID, SourceControlSetting.P4_CLIENT_VIEW_SOURCE, Byte.toString(SourceControlSetting.P4_CLIENT_VIEW_SOURCE_VALUE_DEPOT_PATH));
      TestHelper.setSourceControlProperty(TEST_BUILD_ID, SourceControlSetting.P4_CLIENT_VIEW_BY_DEPOT_PATH, DEPOT_PATH_NONEXISTING_SOURCE);
      perforce.reloadConfiguration();
      perforce.syncToChangeList(TEST_CHANGE_LIST_ID_10);
  ...
  public void test_syncToChangeListMultiline() throws Exception {
    TestHelper.setSourceControlProperty(TEST_BUILD_ID, SourceControlSetting.P4_DEPOT_PATH, STRING_SOURCE_LINE_MULTY_1);
    perforce.reloadConfiguration();
    perforce.syncToChangeList(TEST_CHANGE_LIST_ID_10);
    TestHelper.assertCheckoutDirNotEmpty(agent);
...
//    TestHelper.assertCurrentBuildPathExists(perforce);
  ...
  public void test_bug737syncToLatestWorksWithSpacedPath() throws CommandStoppedException, BuildException, IOException, AgentFailureException {
    errorManager.clearAllActiveErrors();
    TestHelper.setSourceControlProperty(TEST_BUILD_ID, SourceControlSetting.P4_DEPOT_PATH, "//test/sourceline with spaces/...");
    perforce.reloadConfiguration();
    perforce.checkoutLatest();
    TestHelper.assertCheckoutDirNotEmpty(agent);
    assertEquals(0, errorManager.errorCount());
  ...
  public void test_bug630syncToLatestReservedMSDOSPath() throws CommandStoppedException, BuildException, IOException, AgentFailureException {
    TestHelper.setSourceControlProperty(TEST_BUILD_ID, SourceControlSetting.P4_DEPOT_PATH, "//test/aux/...");
    perforce.reloadConfiguration();
    perforce.checkoutLatest();
    TestHelper.assertCheckoutDirNotEmpty(agent);
    TestHelper.emptyCheckoutDir(agent);
  ...
  public void test_createLabel() throws Exception {
    final String label = "test_label_" + System.currentTimeMillis();
    perforce.createOrUpdateLabel(label, cm.getSourceControlSettingValue(TEST_BUILD_ID, SourceControlSetting.P4_DEPOT_PATH, null));
  }
  ...
  public void test_getChangesSincePicksUpIntegOnlyBranches() throws Exception {
    TestHelper.setSourceControlProperty(TEST_BUILD_ID, SourceControlSetting.P4_DEPOT_PATH, "//test/sourceline_with_branch_integ_only/...");
    perforce.reloadConfiguration();
...
//  }
  ...
  public void test_getChangesSinceFailsOnWrongPassword() throws Exception {
    TestHelper.setSourceControlProperty(TEST_BUILD_ID, SourceControlSetting.P4_PASSWORD, TestHelper.P4_INVALID_PASSWORD);
    try {
      perforce.reloadConfiguration();
      perforce.getChangesSince(TEST_CHANGE_LIST_ID_4);
      TestHelper.failNoExceptionThrown();
  ...
  public void test_getChangesSinceFailsOnWrongExecutable() throws Exception {
    TestHelper.setSourceControlProperty(TEST_BUILD_ID, SourceControlSetting.P4_PATH_TO_CLIENT, "there_is_no_such_executable");
    try {
      perforce.reloadConfiguration();
      perforce.getChangesSince(TEST_CHANGE_LIST_ID_4);
      TestHelper.failNoExceptionThrown();
  ...
  public void test_getChangesSinceFailsOnWrongPort() throws Exception {
    TestHelper.setSourceControlProperty(TEST_BUILD_ID, SourceControlSetting.P4_PORT, "there_is_no_such_host:555");
    try {
      perforce.reloadConfiguration();
      perforce.getChangesSince(TEST_CHANGE_LIST_ID_4);
      TestHelper.failNoExceptionThrown();
  ...
  public void test_syncToLatestFailsOnNonExistingDepotPath() throws Exception {
    TestHelper.setSourceControlProperty(TEST_BUILD_ID, SourceControlSetting.P4_DEPOT_PATH, "//test/there_is_no_such_depot_path");
    try {
      perforce.reloadConfiguration();
      perforce.checkoutLatest();
      TestHelper.failNoExceptionThrown();
  ...
  public void test_checkOutLatestCatchesConfigUpdates() throws Exception {
    ...
    // update property
    TestHelper.setSourceControlProperty(TEST_BUILD_ID, SourceControlSetting.P4_DEPOT_PATH, STRING_SOURCE_LINE_TWO);
  ...
  public void test_getChangeListCounter() throws Exception {
    TestHelper.setSourceControlProperty(TEST_BUILD_ID, SourceControlSetting.P4_COUNTER, "change");
    perforce.reloadConfiguration();
