...
public final class SSTestClearCaseSourceControl extends AbstractSourceControlTest {
  ...
  public void test_checkOutLatestCatchesConfigUpdates() throws Exception {
    ...
    final SourceControlSetting viewSpec = cm.getSourceControlSetting(TEST_CLEARCASE_BUILD_ID, SourceControlSetting.CLEARCASE_VIEW_CONFIG_SPEC);
    viewSpec.setPropertyValue("element * CHECKEDOUT\nelement * /main/LATEST\nload \\test_parabuild_vob\\test\\second_sourceline");
    cm.saveObject(viewSpec);
    final SourceControlSetting buildDir = cm.getSourceControlSetting(TEST_CLEARCASE_BUILD_ID, SourceControlSetting.CLEARCASE_RELATIVE_BUILD_DIR);
  ...
  public void test_checkOutLatestCantProcessUnexistingSourceLine() throws Exception {
    ...
    final SourceControlSetting setting = cm.getSourceControlSetting(TEST_CLEARCASE_BUILD_ID, SourceControlSetting.CLEARCASE_VIEW_CONFIG_SPEC);
...
//    assertTrue(newChangeList.getDescription().startsWith("Added always empty folder"));
  ...
  public void test_getChangesSinceWithStorageLocation() throws Exception {
    ...
    final SourceControlSetting setting = new SourceControlSetting(TEST_CLEARCASE_BUILD_ID, SourceControlSetting.CLEARCASE_VIEW_STORAGE_LOCATION, "Views");
    cm.saveObject(setting);
