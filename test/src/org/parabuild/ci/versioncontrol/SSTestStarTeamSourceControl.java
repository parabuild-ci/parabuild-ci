...
public final class SSTestStarTeamSourceControl extends AbstractSourceControlTest {
  ...
  public void test_getChangesSinceInBranch() throws Exception {
    // update property
    TestHelper.setSourceControlProperty(getTestBuildID(), VersionControlSystem.STARTEAM_PROJECT_PATH, "test_project/Release 1 release-prep codeline");
  ...
  public void test_checkOutLatestCatchesConfigUpdates() throws Exception {
    ...
    // update property
    TestHelper.setSourceControlProperty(getTestBuildID(), VersionControlSystem.STARTEAM_PROJECT_PATH, STRING_SOURCE_LINE_TWO);
    starTeam.reloadConfiguration();
  ...
  public void test_checkOutMultilineRepositoryPath() throws Exception {
    ...
    TestHelper.setSourceControlProperty(starTeam.getBuildID(), VersionControlSystem.STARTEAM_PROJECT_PATH, multilineSourceLine);
  ...
  public void test_checkOutLatestCantProcessUnexistingSourceLine() throws Exception {
    // alter
    TestHelper.setSourceControlProperty(starTeam.getBuildID(), VersionControlSystem.STARTEAM_PROJECT_PATH, "/test/never/existed");
    starTeam.reloadConfiguration();
  ...
  public void test_checkOutLatestCantProcessInavalidUser() throws Exception {
    // alter
    TestHelper.setSourceControlProperty(starTeam.getBuildID(), VersionControlSystem.STARTEAM_USER, "never_existed_user");
    starTeam.reloadConfiguration();
  ...
  public void test_syncToChangeListPicksUpConfigChanges() throws Exception {
    ...
    // alter
    TestHelper.setSourceControlProperty(starTeam.getBuildID(), VersionControlSystem.STARTEAM_PROJECT_PATH, STRING_SOURCE_LINE_TWO);
    starTeam.reloadConfiguration();
    starTeam.syncToChangeList(starTeam.getChangesSince(-1));
    final String oldRelativeBuildDir = TestHelper.assertCurrentBuildPathExists(starTeam, agent);

    // update property
    TestHelper.setSourceControlProperty(starTeam.getBuildID(), VersionControlSystem.STARTEAM_PROJECT_PATH, STRING_SOURCE_LINE_ONE);
    starTeam.reloadConfiguration();
  ...
  public void test_canNotAccessWithWrongPassword() throws Exception {
    // alter
    TestHelper.setSourceControlProperty(starTeam.getBuildID(), VersionControlSystem.STARTEAM_PASSWORD, org.parabuild.ci.security.SecurityManager.encryptPassword("wrong_passord"));
    starTeam.reloadConfiguration();
