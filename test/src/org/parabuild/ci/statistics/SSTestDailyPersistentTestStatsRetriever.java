 ...
 */
public class SSTestDailyPersistentTestStatsRetriever extends ServersideTestCase {

  private static final Log log = LogFactory.getLog(SSTestDailyPersistentTestStatsRetriever.class);

  private DailyPersistentTestStatsRetriever statsRetriever = null;
  private ErrorManager errorManager;


  public SSTestDailyPersistentTestStatsRetriever(final String s) {
    super(s);
  }
  ...
  public void test_getStatistics() {
    ...
    assertEquals(DailyPersistentTestStatsRetriever.DEFAULT_STATS_DAYS, statistics.size());
...
//      if (log.isDebugEnabled()) log.debug("(truncatedSampleTime.getTime() - sampleTime.getTime()): " + (truncatedSampleTime.getTime() - sampleTime.getTime()));
  ...
  public static TestSuite suite() {
    return new TestSuite(SSTestDailyPersistentTestStatsRetriever.class);
  }
  ...
  protected void setUp() throws Exception {
    ...
    statsRetriever = new DailyPersistentTestStatsRetriever(TestHelper.TEST_CVS_VALID_BUILD_ID, PersistentTestStats.TYPE_JUNIT);
  }
}
