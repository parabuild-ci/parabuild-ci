 ...
 */
public class SSTestHourlyPersistentTestStatsRetriever extends ServersideTestCase {

  private static final Log log = LogFactory.getLog(SSTestHourlyPersistentTestStatsRetriever.class);

  private HourlyPersistentTestStatsRetriever statsRetriever = null;
  private ErrorManager errorManager;


  public SSTestHourlyPersistentTestStatsRetriever(final String s) {
    super(s);
  }
  ...
  public void test_getStatistics() {
    ...
    assertEquals(HourlyPersistentTestStatsRetriever.DEFAULT_STATS_HOURS, statistics.size());
  ...
  public static TestSuite suite() {
    return new TestSuite(SSTestHourlyPersistentTestStatsRetriever.class);
  }
  ...
  protected void setUp() throws Exception {
    ...
    statsRetriever = new HourlyPersistentTestStatsRetriever(TestHelper.TEST_CVS_VALID_BUILD_ID,  PersistentTestStats.TYPE_JUNIT);
  }
}
