 ...
 */
public class SSTestP4ManualScheduleStartParametersPanel extends ServletTestCase {
  ...
  private P4ManualScheduleStartParametersPanel panel = null;


  public SSTestP4ManualScheduleStartParametersPanel(final String s) {
    super(s);
  }
  ...
  public void test_load() throws Exception {
    ...
    for (int i = 0; i < updatedSettings.size(); i++) {
      ...
      if (vo.getName().equals(SourceControlSettingVO.P4_DEPOT_PATH) && vo.getValue().equals(TEST_DEPOT_PATH)) {
        found = true;
        break;
      }
    }
  ...
  public static TestSuite suite() {
    return new TestSuite(SSTestP4ManualScheduleStartParametersPanel.class);
  }
  ...
  protected void setUp() throws Exception {
    ...
    final boolean showDepotPathOverride = true;
    final boolean showChangeListNumber = true;
    panel = new P4ManualScheduleStartParametersPanel(showDepotPathOverride, showChangeListNumber);
  }
}
