 ...
 *
 */
public class SSTestTextDirLogConfigPanel extends ServersideTestCase {

  private TextDirLogConfigPanel pnlLogConfig = null;
   ...
   * Required by JUnit
   */
  public SSTestTextDirLogConfigPanel(final String s) {
    super(s);
  }


  public static TestSuite suite() {
    return new TestSuite(SSTestTextDirLogConfigPanel.class);
  }


  protected void setUp() throws Exception {
    super.setUp();
    pnlLogConfig = new TextDirLogConfigPanel();
  }
}
