 ...
 *
 */
public class SSTestHTMLDirLogConfigPanel extends ServersideTestCase {

  private HTMLDirLogConfigPanel pnlLogConfig = null;
  ...
  /**
   */
  public void test_validatesValid() throws Exception {
    load();
  ...
  /**
   */
  public void test_invalidatesIncomplete() throws Exception {
    // somwaht empty
    assertTrue(!pnlLogConfig.validate());

    load();

    // does not validate w/emply index file name
    pnlLogConfig.setIndexFileName(""); // clear index file name
    assertTrue(!pnlLogConfig.validate());
  }
   ...
   * Required by JUnit
   */
  public SSTestHTMLDirLogConfigPanel(final String s) {
    super(s);
  }


  public static TestSuite suite() {
    return new TestSuite(SSTestHTMLDirLogConfigPanel.class);
  }


  protected void setUp() throws Exception {
    super.setUp();
    pnlLogConfig = new HTMLDirLogConfigPanel();
  }
}
