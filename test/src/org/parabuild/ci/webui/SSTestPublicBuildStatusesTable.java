 ...
 * Tests home page
 */
public class SSTestPublicBuildStatusesTable extends ServersideTestCase {

  private BuildStatusesTable statusesTable = null;


  public SSTestPublicBuildStatusesTable(final String s) {
    super(s);
  }
  ...
  public void testPopulate() throws Exception {
    statusesTable.populate();
  }


  protected void setUp() throws Exception {
    super.setUp();
    statusesTable = new BuildStatusesTable(0);
  ...
  public static TestSuite suite() {
    return new TestSuite(SSTestPublicBuildStatusesTable.class);
  }
}
