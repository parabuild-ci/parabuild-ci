 ...
 *
 */
public class SSTestDirResultConfigPanel extends ServersideTestCase {
   ...
   * Required by JUnit
   */
  public SSTestDirResultConfigPanel(final String s) {
    super(s);
  }


  public static TestSuite suite() {
    return new TestSuite(SSTestDirResultConfigPanel.class);
  }
