 ...
 */
public class SSTestProcessManagerFactory extends TestCase {

  private static final Log log = LogFactory.getLog(SSTestProcessManagerFactory.class);
  ...
  public SSTestProcessManagerFactory(final String s) {
    super(s);
  }
  ...
  public void test_listExtended() throws Exception {
    ...
    if (agentEnv.isWindows()) {
      ...
      // REVIEWME: simeshev@parabuilci.org -> does not work with PV.EXE
  ...
  public void test_killTree() throws Exception {
    ...
    // NOTE: simeshev@parabuilci.org - I added this kill to let test pass
  ...
  public void test_getChildrenAndKillAllAscending() throws Exception {
    ...
    final List toKill = new ArrayList();
...
//     assertEquals(13, procList.size());
  ...
  public static TestSuite suite() {
    return new TestSuite(SSTestProcessManagerFactory.class);
  }
}
