...
insert into USERS (ID, NAME, FNAME, PASSWORD, IS_ADMIN, EMAIL, ROLES, ENABLED, IM_TYPE, IM_ADDRESS, TIMESTAMP) values(0, 'admin', '', '21232F297A57A5A743894A0E4A801FC3', 'Y', '', 'admin', 'Y', 0, '', 1);
insert into SYSTEM_PROPERTY (ID, NAME, VALUE, TIMESTAMP) values (0, 'parabuild.schema.version', '29', 1);
...
insert into GROUPS (ID, NAME, DESCR, ENABLED, ALLOWED_TO_CREATE_BUILD, ALLOWED_TO_DELETE_BUILD, ALLOWED_TO_START_BUILD, ALLOWED_TO_STOP_BUILD, ALLOWED_TO_UPDATE_BUILD, ALLOWED_TO_VIEW_BUILD, TIMESTAMP) values (0, 'Anonymous', 'Users that are not logged in', 'Y', 'N', 'N', 'N', 'N', 'N', 'Y', 0);
