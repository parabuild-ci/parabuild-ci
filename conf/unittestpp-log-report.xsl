...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:param name="h2.style"
               select="'margin-top: 1em; margin-bottom: 0.5em; font: bold 11px verdana,arial,helvetica'"/>
    ...
    <xsl:param name="details.style"
               select="'font-size: 11px; font-weight: normal; text-align:left; background:#E3E3E3;'"/>
    ...
    <xsl:template name="summary">
        ...
        <xsl:variable name="testCount" select="sum(/testsuites/unittest-results/@tests)"/>
        <xsl:variable name="errorCount" select="sum(/testsuites/unittest-results/@errors)"/>
        <xsl:variable name="failureCount" select="sum(/testsuites/unittest-results/@failedtests)"/>
        <xsl:variable name="timeCount" select="sum(/testsuites/unittest-results/@time)"/>
