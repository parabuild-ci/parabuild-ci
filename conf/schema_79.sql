...
insert into SYSTEM_PROPERTY (ID, NAME, VALUE, TIMESTAMP) values (0, 'parabuild.schema.version', '79', 1);
...
insert into AGENT (ID, HOST, DESCRIPTION, ENABLED, SERIALIZE, CAPACITY, DELETED, TIMESTAMP) values (0, '<Build Manager>', 'Agent that runs on the build manager machine', 'Y', 'N', 1, 'N', 0);
