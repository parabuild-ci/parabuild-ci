...
insert into SYSTEM_PROPERTY (ID, NAME, VALUE, TIMESTAMP) values (0, 'parabuild.schema.version', '77', 1);
...
insert into AGENT (ID, HOST, DESCRIPTION, ENABLED, SERIALIZE, DELETED, TIMESTAMP) values (0, '<Build Manager>', 'Agent that runs on the build manager machine', 'Y', 'N', 'N', 0);
