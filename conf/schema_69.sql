...
constraint MANUAL_RUN_PARAMETER_ATTRIBUTE_UC2 unique (BUILD_ID, TYPE, NAME),
...
insert into SYSTEM_PROPERTY (ID, NAME, VALUE, TIMESTAMP) values (0, 'parabuild.schema.version', '69', 1);
