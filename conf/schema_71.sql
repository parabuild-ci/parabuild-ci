...
insert into SYSTEM_PROPERTY (ID, NAME, VALUE, TIMESTAMP) values (0, 'parabuild.schema.version', '71', 1);
...
insert into CLUSTER (ID, NAME, DESCR, ENABLED, DELETED, TIMESTAMP) values (0, 'Local Builder', 'Builder that runs builds on the build manager machine', 'Y', 'N', 0);
