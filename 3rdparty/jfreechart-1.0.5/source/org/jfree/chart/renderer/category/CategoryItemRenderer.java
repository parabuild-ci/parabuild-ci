 ...
 *
 * $Id: CategoryItemRenderer.java,v 1.10.2.2 2007/02/20 15:38:56 mungady Exp $
 *
 * Changes
 * -------
...
public interface CategoryItemRenderer extends LegendItemSource {
    ...
    // FIXME: Why no getPaint() method?  Probably just an oversight.
    ...
    // FIXME: Why no getOutlinePaint?  Probably just an oversight.
    ...
    // FIXME: Why no getStroke?  Probably just an oversight.
    ...
    // FIXME: Why no getOutlineStroke?  Probably just an oversight.
    ...
    // FIXME: Why no getShape()?  Probably just an oversight.
    ...
    // FIXME: Why no isItemLabelsVisible()?  Probably just an oversight.
    ...
    // FIXME: Why no getItemLabelGenerator()?  Probably just an oversight.
