...
javac -O -nowarn -d ../classes -classpath "%classpath%;../classes;../lib/servlet.jar;." ./*.java org/hsqldb/*.java org/hsqldb/jdbc/*.java org/hsqldb/rowio/*.java org/hsqldb/scriptio/*.java org/hsqldb/store/*.java org/hsqldb/lib/*.java org/hsqldb/util/*.java
...
jar -cf ../lib/hsqldb.jar *.class org/hsqldb/*.class org/hsqldb/jdbc/*.class org/hsqldb/rowio/*.class org/hsqldb/scriptio/*.class org/hsqldb/store/*.class org/hsqldb/lib/*.class org/hsqldb/util/*.class  org/hsqldb/util/*.gif
cd ..\build
pause
