...
Welcome to the JavaMail API 1.4.2 release!  This release includes
...
------------
  ...
  2. Set your CLASSPATH to include the "mail.jar" file obtained from 
     ...
     Assuming you unzipped javamail1_4_2.zip in c:\download the
     following would work:
     
      set CLASSPATH=%CLASSPATH%;c:\download\javamail-1.4.2\mail.jar;.
