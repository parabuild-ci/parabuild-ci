 ...
 *
 * $Id: DefaultBoxAndWhiskerXYDataset.java,v 1.1 2004/08/31 15:32:24 mungady Exp $
 *
 * Changes
 * -------
...
public class DefaultBoxAndWhiskerXYDataset extends AbstractXYDataset 
     ...
     * <p>
     * This method (from the XYDataset interface) is mapped to the getMaxNonOutlierValue(...) 
     * method.
     *
     * @param series  the series (zero-based index).
     * @param item  the item (zero-based index).
