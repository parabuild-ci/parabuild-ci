 ...
 * Contributor(s):   -;
 *
 * $Id: RegressionTests.java,v 1.1 2004/08/31 15:32:54 mungady Exp $
 *
 * Changes
 * -------
...
public class RegressionTests extends TestCase {
     ...
     */
    public RegressionTests(final String name) {
        super(name);
    }
    ...
    private double[][] createSampleData1() {
        ...
        final double[][] result = new double[11][2];
    ...
    private double[][] createSampleData2() {
        ...
        final double[][] result = new double[10][2];
