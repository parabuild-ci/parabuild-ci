 ...
 * Contributor(s):   -;
 *
 * $Id: BoxAndWhiskerItem.java,v 1.1 2004/08/31 15:32:24 mungady Exp $
 *
 * Changes
 * -------
...
public class BoxAndWhiskerItem implements Serializable {
     ...
     * @param minRegularValue  the minimum regular value (<code>null</code> permitted).
     * @param maxRegularValue  the maximum regular value (<code>null</code> permitted).
