 ...
 * Contributor(s):   -;
 *
 * $Id: DefaultKeyedValueTests.java,v 1.1 2004/08/31 15:31:05 mungady Exp $
 *
 * Changes
 * -------
...
public class DefaultKeyedValueTests extends TestCase {
     ...
     */
    public DefaultKeyedValueTests(final String name) {
        super(name);
    }
    ...
    public void testCloning() {
        final DefaultKeyedValue v1 = new DefaultKeyedValue("Test", new Double(45.5));
    ...
    public void testSerialization() {
        ...
        final DefaultKeyedValue v1 = new DefaultKeyedValue("Test", new Double(25.3));
        DefaultKeyedValue v2 = null;
