...
public class TimeSeries extends Series implements Cloneable, Serializable {
    ...
    /**
     * Adds a data item to the series and sends a {@link org.jfree.data.general.SeriesChangeEvent} 
    ...
    /**
     * Adds a new data item to the series and sends a {@link org.jfree.data.general.SeriesChangeEvent} 
     * to all registerd listeners.
     *
     * @param period  the time period (<code>null</code> not permitted).
     ...
     * {@link org.jfree.data.general.SeriesChangeEvent} to all registered listenrs.
     *
    ...
    /**
     * Removes all data items from the series and sends a {@link org.jfree.data.general.SeriesChangeEvent}
     ...
     * a {@link org.jfree.data.general.SeriesChangeEvent} to all registered listeners.
     *
    ...
    public boolean equals(Object object) {
        ...
        if (!ObjectUtils.equal(getDomainDescription(), s.getDomainDescription())) {
            return false;
        }

        if (!ObjectUtils.equal(getRangeDescription(), s.getRangeDescription())) {
            return false;
        }
