 ...
 * Contributor(s):   -;
 *
 * $Id: TimeSeriesDataItemTests.java,v 1.1 2004/08/31 15:34:54 mungady Exp $
 *
 * Changes
 * -------
...
public class TimeSeriesDataItemTests extends TestCase {
     ...
     */
    public TimeSeriesDataItemTests(final String name) {
        super(name);
    }
    ...
    public void testEqualsSelf() {
        final TimeSeriesDataItem item = new TimeSeriesDataItem(new Day(23, 9, 2001), 99.7);
    ...
    public void testEquals() {
        final TimeSeriesDataItem item1 = new TimeSeriesDataItem(new Day(23, 9, 2001), 99.7);
        final TimeSeriesDataItem item2 = new TimeSeriesDataItem(new Day(23, 9, 2001), 99.7);
