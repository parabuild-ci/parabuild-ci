 ...
 * Contributor(s):   -;
 *
 * $Id: QuarterTests.java,v 1.1 2004/08/31 15:34:54 mungady Exp $
 *
 * Changes
 * -------
...
public class QuarterTests extends TestCase {
     ...
     */
    public QuarterTests(final String name) {
        super(name);
    }
    ...
    /**
     * Problem that a Quarter instance is equal to itself.
     *
    ...
    public void testQ1Y1900Previous() {
        final Quarter previous = (Quarter) this.q1Y1900.previous();
        assertNull(previous);
    }
    ...
    public void testQ1Y1900Next() {
        final Quarter next = (Quarter) this.q1Y1900.next();
    ...
    public void testQ4Y9999Previous() {
        final Quarter previous = (Quarter) this.q4Y9999.previous();
    ...
    public void testQ4Y9999Next() {
        final Quarter next = (Quarter) this.q4Y9999.next();
        assertNull(next);
    }
    ...
    public void testSerialization() {
        ...
        final Quarter q1 = new Quarter(4, 1999);
        Quarter q2 = null;
