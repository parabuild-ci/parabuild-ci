 ...
 * Contributor(s):   -;
 *
 * $Id: SimpleTimePeriodTests.java,v 1.1 2004/08/31 15:34:54 mungady Exp $
 *
 * Changes
 * -------
...
public class SimpleTimePeriodTests extends TestCase {
     ...
     */
    public SimpleTimePeriodTests(final String name) {
        super(name);
    }
    ...
    public void testEqualsSelf() {
        final SimpleTimePeriod p = new SimpleTimePeriod(new Date(1000L), new Date(1001L));
