 ...
 *
 * $Id: TableXYDatasetTests.java,v 1.1 2004/08/31 15:36:54 mungady Exp $
 *
 * Changes
 * -------
...
public class TableXYDatasetTests extends TestCase {
     ...
     */
    public TableXYDatasetTests(final String name) {
        super(name);
    }
    ...
    private XYSeries createSeriesA() {
        final XYSeries s = new XYSeries("A", true, false);
        s.add(1.0, 1.1);
        s.add(2.0, null);
        return s;
    }
    ...
    private XYSeries createSeriesB() {
        final XYSeries s = new XYSeries("B", true, false);
        s.add(1.0, null);
        s.add(2.0, 2.2);
        return s;
    }
