 ...
 * Contributor(s):   -;
 *
 * $Id: AbstractIntervalXYDataset.java,v 1.1 2004/08/31 15:36:12 mungady Exp $
 *
 * Changes
 * -------
 * 05-May-2004 : Version 1 (DG);
 * 15-Jul-2004 : Switched getStartX() and getStartXValue() methods and others (DG);
...
/**
 * An base class that you can use to create new implementations of the {@link IntervalXYDataset}
 * interface.
 */
