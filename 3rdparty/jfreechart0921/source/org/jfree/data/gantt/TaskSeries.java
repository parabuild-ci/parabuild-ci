 ...
 * Contributor(s):   -;
 *
 * $Id: TaskSeries.java,v 1.1 2004/08/31 15:25:36 mungady Exp $
 *
 * Changes
 * -------
 ...
 * can be used to construct basic Gantt charts.
 */
public class TaskSeries extends Series {
    ...
    /**
     * Adds a task to the series and sends a {@link org.jfree.data.general.SeriesChangeEvent} 
    ...
    /**
     * Removes a task from the series and sends a {@link org.jfree.data.general.SeriesChangeEvent} 
     * to all registered listeners.
     *
     * @param task  the task.
     */
    ...
    /**
     * Removes all tasks from the series and sends a {@link org.jfree.data.general.SeriesChangeEvent} 
     * to all registered listeners.
     */
