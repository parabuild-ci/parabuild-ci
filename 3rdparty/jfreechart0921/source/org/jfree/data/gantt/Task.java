 ...
 * Contributor(s):   -;
 *
 * $Id: Task.java,v 1.1 2004/08/31 15:25:36 mungady Exp $
 *
 * Changes
 * -------
 * 10-Jan-2003 : Version 1 (DG);
 * 16-Sep-2003 : Added percentage complete (DG);
 * 30-Jul-2004 : Added clone() and equals() methods and implemented Serializable (DG);
 *
 */
...
public class Task implements Cloneable, PublicCloneable, Serializable {
     ...
     * @return A clone.
     * 
     * @throws CloneNotSupportedException  never thrown by this class, but subclasses may
     *         not support cloning.
     */
