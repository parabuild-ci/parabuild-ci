 ...
 * Contributor(s):   -;
 *
 * $Id: DefaultKeyedValueDatasetTests.java,v 1.1 2004/08/31 15:27:47 mungady Exp $
 *
 * Changes
 * -------
...
public class DefaultKeyedValueDatasetTests extends TestCase {
     ...
     */
    public DefaultKeyedValueDatasetTests(final String name) {
        super(name);
    }
    ...
    public void testCloning() {
        final DefaultKeyedValueDataset d1 = new DefaultKeyedValueDataset("Test", new Double(45.5));
    ...
    public void testCloneIndependence() {
        final DefaultKeyedValueDataset d1 = new DefaultKeyedValueDataset("Key", new Double(10.0));
        DefaultKeyedValueDataset d2 = null;
        try {
            d2 = (DefaultKeyedValueDataset) d1.clone();
        }
            ...
            System.err.println(
                "DefaultKeyedValueDatasetTests.testCloneIndependence: failed to clone."
            );
        }
        assertTrue(d1.equals(d2));
    ...
    public void testSerialization() {
        ...
        final DefaultKeyedValueDataset d1 = new DefaultKeyedValueDataset("Test", new Double(25.3));
        DefaultKeyedValueDataset d2 = null;
