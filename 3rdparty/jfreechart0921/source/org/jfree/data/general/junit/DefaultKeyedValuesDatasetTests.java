 ...
 * Contributor(s):   -;
 *
 * $Id: DefaultKeyedValuesDatasetTests.java,v 1.1 2004/08/31 15:27:47 mungady Exp $
 *
 * Changes
 * -------
...
public class DefaultKeyedValuesDatasetTests extends TestCase {
     ...
     */
    public DefaultKeyedValuesDatasetTests(final String name) {
        super(name);
    }
    ...
    public void testCloning() {
        final DefaultKeyedValuesDataset d1 = new DefaultKeyedValuesDataset();
