 ...
 * Contributor(s):   -;
 *
 * $Id: PieDatasetTests.java,v 1.1 2004/08/31 15:27:47 mungady Exp $
 *
 * Changes
 * -------
 ...
 *
 */
public class PieDatasetTests extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(PieDatasetTests.class);
    }
     ...
     */
    public PieDatasetTests(final String name) {
        super(name);
    }
    ...
    public void testCloning() {
        final DefaultPieDataset d1 = new DefaultPieDataset();
        ...
        try {
            ...
            System.err.println("DefaultPieDatasetTests.testCloning: failed to clone.");
        }
        assertTrue(d1 != d2);
