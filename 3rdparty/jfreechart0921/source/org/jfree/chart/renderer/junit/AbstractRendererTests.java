 ...
 * Contributor(s):   -;
 *
 * $Id: AbstractRendererTests.java,v 1.1 2004/08/31 14:45:33 mungady Exp $
 *
 * Changes
 * -------
...
public class AbstractRendererTests extends TestCase {
    ...
    public void testSetSeriesVisible() {
        ...
        r.setSeriesVisible(new Boolean(true));
    ...
    /**
     * Test that setting the item label visibility for ALL series does in fact work.
     */
    ...
    /**
     * Test that setting the font for ALL series does in fact work (it was broken at
     * one point).
     */
    public void testSetItemLabelFont() {
        BarRenderer r = new BarRenderer();
        r.setItemLabelFont(new Font("SansSerif", Font.PLAIN, 33));
        assertEquals(new Font("SansSerif", Font.PLAIN, 33), r.getItemLabelFont(0, 0));
    }

    /**
     * Test that setting the paint for ALL series does in fact work (it was broken at
     * one point).
     */
