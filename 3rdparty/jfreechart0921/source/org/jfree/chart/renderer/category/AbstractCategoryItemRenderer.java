 ...
 *
 * $Id: AbstractCategoryItemRenderer.java,v 1.1 2004/08/31 14:47:48 mungady Exp $
 *
 * Changes:
 * --------
 ...
 * 14-Jun-2004 : Fixed bug in drawRangeMarker() method - now uses 'paint' and 'stroke' rather
 *               than 'outlinePaint' and 'outlineStroke' (DG);
...
public abstract class AbstractCategoryItemRenderer extends AbstractRenderer
    ...
    /**
     * Sets the label generator for ALL series and sends a {@link RendererChangeEvent}
