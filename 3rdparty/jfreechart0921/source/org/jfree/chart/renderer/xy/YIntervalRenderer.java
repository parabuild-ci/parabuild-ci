 ...
 * Contributor(s):   -;
 *
 * $Id: YIntervalRenderer.java,v 1.1 2004/08/31 14:49:29 mungady Exp $
 *
 * Changes
 * -------
...
public class YIntervalRenderer extends AbstractXYItemRenderer 
    ...
    public void drawItem(Graphics2D g2, 
        ...
        Number x = intervalData.getX(series, item);
        Number yLow   = intervalData.getStartY(series, item);
        Number yHigh  = intervalData.getEndY(series, item);
