 ...
 * Contributor(s):   -;
 *
 * $Id: XYLineAndShapeRenderer.java,v 1.1 2004/08/31 14:49:29 mungady Exp $
 *
 * Changes:
 * --------
...
public class XYLineAndShapeRenderer extends AbstractXYItemRenderer 
     ...
     * Returns the flag used to control whether or not the shape for an item is visible.
     * <p>
     * The default implementation passes control to the <code>getSeriesShapesVisible</code> method.
    ...
    /**
     * Sets the 'shapes visible' for ALL series and sends a {@link RendererChangeEvent}
    ...
    /**
     * Sets the 'shapes visible' flag for a series and sends a {@link RendererChangeEvent}
     * to all registered listeners.
     * 
     * @param series  the series index (zero-based).
     * @param visible  the flag.
