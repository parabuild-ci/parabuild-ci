 ...
 *                    Jerome Fisher;
 *
 * $Id: CandlestickRenderer.java,v 1.2 2004/09/08 09:18:14 mungady Exp $
 *
 * Changes
 * -------
...
public class CandlestickRenderer extends AbstractXYItemRenderer 
     ...
     *
     * @see org.jfree.chart.renderer.xy.CandlestickRenderer#WIDTHMETHOD_AVERAGE
     * @see org.jfree.chart.renderer.xy.CandlestickRenderer#WIDTHMETHOD_SMALLEST
     * @see org.jfree.chart.renderer.xy.CandlestickRenderer#WIDTHMETHOD_INTERVALDATA
     * @see org.jfree.chart.renderer.xy.CandlestickRenderer#setCandleWidth(double)
     * @see org.jfree.chart.renderer.xy.CandlestickRenderer#setAutoWidthGap(double)
     * @see org.jfree.chart.renderer.xy.CandlestickRenderer#setAutoWidthFactor(double)
     * @see org.jfree.chart.renderer.xy.CandlestickRenderer#setMaxCandleWidthInMilliseconds(double)
