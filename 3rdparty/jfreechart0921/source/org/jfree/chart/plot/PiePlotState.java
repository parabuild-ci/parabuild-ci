 ...
 * Contributor(s):   -;
 *
 * $Id: PiePlotState.java,v 1.1 2004/08/31 14:39:21 mungady Exp $
 *
 * Changes
 * -------
...
public class PiePlotState extends RendererState {
    ...
    /**
     * Returns the y-coordinate (in Java2D space) of the center of the pie chart.  For the 
     * {@link PiePlot3D} class, we derive this from the top of the pie.
     * 
