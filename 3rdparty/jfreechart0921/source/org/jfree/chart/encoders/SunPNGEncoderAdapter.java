 ...
 * Contributor(s):   -;
 *
 * $Id: SunPNGEncoderAdapter.java,v 1.1 2004/08/31 14:32:00 mungady Exp $
 *
 * Changes
 * -------
...
/**
 * Adapter class for the Sun PNG Encoder.  The ImageEncoderFactory will only return a
 * reference to this class by default if the library has been compiled under a JDK 1.4+
 * and is being run using a JDK 1.4+.
 *
