 ...
 * Contributor(s):   -;
 *
 * $Id: ImageEncoderFactory.java,v 1.1 2004/08/31 14:32:00 mungady Exp $
 *
 * Changes
 * -------
...
public class ImageEncoderFactory {
     ...
     * @return  The ImageEncoder or null if none available.
     */
    public static ImageEncoder newInstance(String format) {
        ...
        try {
            ...
            System.out.println("Using: " + imageEncoderClass.getName());
