 ...
 * Contributor(s):   -;
 *
 * $Id: BoxAndWhiskerXYToolTipGeneratorTests.java,v 1.1 2004/08/31 14:37:05 mungady Exp $
 *
 * Changes
 * -------
 * 13-Aug-2003 : Version 1 (DG);
 * 27-Feb-2004 : Renamed BoxAndWhiskerItemLabelGenerator --> XYBoxAndWhiskerItemLabelGenerator (DG);
 *
 */
...
public class BoxAndWhiskerXYToolTipGeneratorTests extends TestCase {
    ...
    public void testEquals() {
        ...
        g1 = new BoxAndWhiskerXYToolTipGenerator(
            "{0} --> {1} {2}", new SimpleDateFormat("yyyy"), new DecimalFormat("0.0") 
        );
        ...
        g2 = new BoxAndWhiskerXYToolTipGenerator(
            "{0} --> {1} {2}", new SimpleDateFormat("MMM-yyyy"), new DecimalFormat("0.0")
        );
        assertFalse(g1.equals(g2));
        g2 = new BoxAndWhiskerXYToolTipGenerator(
            "{0} --> {1} {2}", new SimpleDateFormat("yyyy"), new DecimalFormat("0.0")
        ...
        g2 = new BoxAndWhiskerXYToolTipGenerator(
            "{0} --> {1} {2}", new SimpleDateFormat("yyyy"), new DecimalFormat("0.00")
        );
        assertFalse(g1.equals(g2));
        g2 = new BoxAndWhiskerXYToolTipGenerator(
            "{0} --> {1} {2}", new SimpleDateFormat("yyyy"), new DecimalFormat("0.0")
