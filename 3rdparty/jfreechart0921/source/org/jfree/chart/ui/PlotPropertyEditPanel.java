 ...
 *                   Daniel Gredler;
 *
 * $Id: PlotPropertyEditPanel.java,v 1.1 2004/08/31 14:54:21 mungady Exp $
 *
    ...
    public PlotPropertyEditPanel(Plot plot) {
        ...
        if(plot instanceof CategoryPlot) {
            ...
            if(renderer instanceof LineAndShapeRenderer) {
                ...
                this.drawLines = new Boolean( r.isDrawLines() );
                this.drawShapes = new Boolean( r.isDrawShapes() );
            }
        }
        else if(plot instanceof XYPlot) {
            ...
            if(renderer instanceof StandardXYItemRenderer) {
                ...
                this.drawLines = new Boolean( r.getPlotLines() );
                this.drawShapes = new Boolean( r.getPlotShapes() );
            }
        }
...
//dmo: (end dmo additions)
    ...
    private void attemptDrawLinesSelection() {
        this.drawLines = new Boolean( this.drawLinesCheckBox.isSelected() );
    }
    ...
    private void attemptDrawShapesSelection() {
        this.drawShapes = new Boolean( this.drawShapesCheckBox.isSelected() );
    }
    ...
    public void updatePlotProperties(Plot plot) {
        ...
        if(this.drawLines != null) {
            if(plot instanceof CategoryPlot) {
                ...
                if(r instanceof LineAndShapeRenderer) {
                    ((LineAndShapeRenderer)r).setDrawLines(this.drawLines.booleanValue());
                }
            }
            else if(plot instanceof XYPlot) {
                XYPlot p = (XYPlot) plot;
        ...
        if(this.drawShapes != null) {
            if(plot instanceof CategoryPlot) {
                ...
                CategoryItemRenderer r = p.getRenderer();
                if(r instanceof LineAndShapeRenderer) {
                    ((LineAndShapeRenderer)r).setDrawShapes(this.drawShapes.booleanValue());
                }
            }
            else if(plot instanceof XYPlot) {
                XYPlot p = (XYPlot) plot;
                XYItemRenderer r = p.getRenderer();
                if(r instanceof StandardXYItemRenderer) {
                    ((StandardXYItemRenderer)r).setPlotShapes(this.drawShapes.booleanValue());
                }
            }
        }
