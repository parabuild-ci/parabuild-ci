...
public class Feed extends WireFeed {
    ...
    /**
     * Sets the feed tagline (Atom 0.3, maps to {@link getSubtitle()}).
     * <p>
    ...
    /**
     * Sets the feed copyright (Atom 0.3, maps to {@link setRights()}).
     * <p>
    ...
    /**
     * Sets the feed modified date (Atom 0.3, maps to {@link setUpdated()}).
     * <p>
